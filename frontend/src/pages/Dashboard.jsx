...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchBlogs = async () => {
      try {
        ...
        if (!ignore) console.error("Fetch Error:", error);
      }
    };
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 pt-24">
      <aside className="w-full md:w-72 bg-white border-r border-gray-200 p-6">
        <div className="mb-10 px-2">
          ...
          <p className="text-xs text-gray-400 uppercase font-bold mt-1 tracking-widest">
            Management
          </p>
        </div>
          ...
          {activeTab === "post" ? (
            <section>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <label className="group flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:border-orange-500 hover:bg-orange-50 transition-all">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      <HiCloudUpload
                        size={40}
                        className="text-gray-400 group-hover:text-orange-500 mb-2"
                      />
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-gray-900 text-white font-bold py-4 rounded-xl hover:bg-orange-600 transition-all shadow-xl active:scale-[0.98] disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
            ...
            <section>
              <header className="mb-8">
                ...
                <p className="text-gray-500">
                  You have published {blogs.length} articles.
                </p>
              </header>
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-center">
                            {String(blog.author?.id) === String(user?._id) ? (
                              <button
                                onClick={() =>
                                  removeBlog(blog._id, blog.author?.id)
                                }
